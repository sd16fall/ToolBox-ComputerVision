...
face_cascade = cv2.CascadeClassifier('/home/alyssawu/ToolBox-ComputerVision/haarcascade_frontalface_alt.xml')
...
while(True):
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.ellipse(frame, (int(x + w/2), int(y + 2*h/3)), (int(w/4), int(h/5)), 0, 0, 150, (0, 0, 0), 10)
